...
class KuliahController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if ($editdata) {
            return view('editmatkul', compact('editdata', 'key'));
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($res_updated) {
            return redirect('matakuliah')->with('status', 'Berhasil mengubah data');
        } else {
            return redirect('matakuliah')->with('status', 'Gagal mengubah data');
        }
    }
    ...
    public function exportjson(Request $request)
    {
        ...
        if ($export_data) {
            return redirect('matakuliah')->with('status', 'Berhasil menambahkan data ke database');
        } else {
